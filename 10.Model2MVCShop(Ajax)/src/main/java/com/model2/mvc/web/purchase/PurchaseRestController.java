...
public class PurchaseRestController {
	...
	@RequestMapping(value="json/listSale/{prodNo}", method = RequestMethod.GET)
	public Map listSale(@PathVariable("prodNo") int prodNo) throws Exception {
		
		System.out.println("/purchase/json/listSale : GET");
